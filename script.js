...
const products = [
    {
        ...
        specs: ["CPU: Intel i7-13700H", "RAM: 16GB", "SSD: 512GB", "Màn hình: 13.4 inch OLED"]
    },
    {
        id: 2,
        name: "MacBook Pro 14",
        image: 'images/Laptop Ultra 2023.jpg',
        description: "Hiệu năng mạnh mẽ, thiết kế sang trọng",
        price: "45,000,000 VNĐ",
        specs: ["CPU: Apple M2 Pro", "RAM: 32GB", "SSD: 1TB", "Màn hình: 14.2 inch Retina"]
    },
    {
        id: 3,
        name: "Asus ROG Zephyrus",
        image: 'images/Laptop Ultra 2023.jpg',
        description: "Laptop gaming đỉnh cao",
        price: "38,000,000 VNĐ",
        specs: ["CPU: AMD Ryzen 9", "RAM: 32GB", "SSD: 1TB", "GPU: RTX 4070"]
    }
];
...
function openModal(product) {
    ...
    modalTitle.textContent = product.name;
    modalImage.src = product.image;
    modalPrice.textContent = `Giá: ${product.price}`;
